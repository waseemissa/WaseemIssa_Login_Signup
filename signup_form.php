...
<head>
    <title>Login / Signup - Waseem Issa</title>
    <meta charset="UTF-8">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form action="signup.php" method="POST" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input">
                        <center><input style="float:left; width: 20px; height: 20px" required type="checkbox"
                                name="agree" value="agree">Agree to Terms and Conditions</input>
                            <center>
                    </div>
